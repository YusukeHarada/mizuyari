...
export const PLANT_TYPES: PlantType[] = [
  { id: 'foliage',   name_ja: '観葉植物',     base_interval_days: 10, emoji: '🌿' },
  { id: 'succulent', name_ja: '多肉植物',     base_interval_days: 14, emoji: '🪴' },
  { id: 'cactus',    name_ja: 'サボテン',     base_interval_days: 21, emoji: '🌵' },
  { id: 'flowering', name_ja: '花植物',       base_interval_days: 7,  emoji: '🌸' },
  { id: 'herb',      name_ja: 'ハーブ',       base_interval_days: 4,  emoji: '🌱' },
